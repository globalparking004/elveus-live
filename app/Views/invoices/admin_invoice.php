        ...
        <div class="content-body">
            ...
            <div class="card">
                <ul class="nav nav-tabs mt-1">
                  ...
                  <li><a data-toggle="tab" href="#suppliertab" class="atab">Supplier</a></li>
                  <li><a data-toggle="tab" href="#airportab" class="atab">Supplier By Airport</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div id="airportab" class="tab-pane">
                        <h5 class="card-header">Search Filter </h5>
                        ...
                        <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
                            ...
                            <div class="col-md-4 col-6">
                                <div class="mb-1">
                                    <label class="form-label">Product</label>
                                    <select class="form-select select2 product" id="product3" name="product">
                                        <option value="">Select Product</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-6">
                                <div class="mb-1">
                                    <label class="form-label" for="contactNumber">Supplier</label>
                                    <select class="form-select select2" id="supplier3" name="supplier">
                                        <option value="*">All</option>
                                            <?php $agents = get_agents();
                                            foreach ($agents as $code => $name) {
                                                echo "<option value='".$code."'>".$name."</option>";
                            ...
                            <div class="col-md-6 col-6">
                                <div class="mb-1">
                                    <label class="form-label">Date From</label>
                                    <input type="text" id="DateFrom3" name="DateFrom" class="form-control DateFrom" />
                                </div>
                            </div>
                            <div class="col-md-4 col-6">
                                <div class="mb-1">
                                    <label class="form-label">DateTo</label>
                                    <input type="text" id="DateTo3" name="DateTo" class="form-control DateTo" />
                                </div>
                            </div>
                            <div class="col-md-2 col-6">
                        ...
                        <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
                            <div class="col-md-6 col-6">
                                <div class="mb-1">
                                    <button type="submit" id="" onclick="search_supplier_airport_data();" class="btn btn-primary">Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="table-responsive border webtable">
                        <table id="webbookingTable" class="table table-striped" style="width: 100%;">
                            <thead>
                                <tr>
                                <th id="tctitle">Product</th>
                                <th>QTY</th>
                                <th>Collected</th>
                                <th>NoShow</th>
                                <th>Gross Amount</th>
                                <th>Net Amount</th>
                                <th>Collect Gross Amount</th>
                                <th>Collect Net Amount</th>
                                <th id="tcfee">Fee</th>
                                <th>Download</th>
                                </tr>
                            </thead>
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="amountData" id="amountData">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row ">
                                        <h6>Admin Income Calculation</h6>
                                        <hr>
                                        <div class="col-md-10 offset-md-2">
                                            <div class="row">
                                                <div class="col-md-8 text-end">
                                            ...
                                            <hr style="width: 88%;">
                                                ...
                                                <div class="col-md-3 text-end">
                                                    <form class="form-crud" action="<?= base_url('invoices/admin/generate'); ?>" method="GET">
                                                        ...
                                                        <input type="hidden" name="gnetAmount" id="gnetAmount">
...
<script type="text/javascript">
    ...
    $('#airport3').on('change', function() 
    {
        $.ajax({
            ...
            complete: function (data) {
                ...
                $('#product3').html(data.responseText);
            }
        });
    });
    ...
    function search_data() 
    {
        ...
        $.ajax({
            ...
            complete: function (data) {
                ...
                let payable = (parseFloat(grossIncome) + parseFloat(totFee) + parseFloat(extra_price)).toFixed(2);
                if (saleTotal == 0) {
                    payable=0;
                }
                ...
                $('#gtotFee').val(totFee);
                $('#gnetAmount').val(data.responseJSON.netAmount);
    ...
    function search_supplier_data() 
    {
        ...
        $.ajax({
            ...
            complete: function (data) {
                ...
                let payable = (parseFloat(grossIncome) + parseFloat(extra_price)).toFixed(2);
                if (saleTotal == 0) {
                    payable=0;
                }
                $('#payable').html(payable);
                ...
                $('#gdateTo').val(data.responseJSON.dateTo);
                $('#gtotFee').val(0);
                $('#gnetAmount').val(data.responseJSON.totNetAmount);
                $('#gsaleTotal').val(saleTotal);
    ...
    function search_supplier_airport_data() 
    {
        ...
        $.ajax({
            url: "<?= url_to('invoices/admin/get-supplier-airport-invoice'); ?> ",
            type: 'GET',
            data: {
                airport : $("#airport3").val(),
                product : $("#product3").val(),
                supplier : $("#supplier3").val(),
