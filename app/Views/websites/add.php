...
<div class="app-content content ">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-body">
      ...
      <!-- Vertical Wizard -->
      <form action="<?= base_url('domains/save'); ?>" method="POST" id="frmsubmit">
        <?= csrf_field() ?>
            ...
            <div class="card">
            	<div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
                  ...
                  <div class="col-md-3">
                      ...
                      <input class="form-control" type="text" name="airport_name" id="airport_name">
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" name="legal_name" id="legal_name">
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-3">
                      <label class="form-label" for="logo">Reviews</label>
                      <input class="form-control" type="file" name="reviews" id="reviews">
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="header_color">Header Color</label>
                      <input class="form-control" type="text" name="header_color" id="header_color">
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="footer_color">Footer Color</label>
                      <input class="form-control" type="text" name="footer_color" id="footer_color">
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="google_analytics_id">Google Analytics ID</label>
                      <input class="form-control" type="text" name="google_analytics_id" id="google_analytics_id">
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="google_adwords_id">Google Adwords ID</label>
                      <input class="form-control" type="text" name="google_adwords_id" id="google_adwords_id">
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="google_conversion_event_id">Google Conversion Event ID</label>
                      <input class="form-control" type="text" name="google_conversion_event_id" id="google_conversion_event_id">
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" id="customer_service" name="customer_service">
                  </div>
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" id="company_id" name="company_id">
                  </div>
                  
                  <div class="col-md-6">
                      <label class="form-label" for="footer">Footer</label>
                      <input class="form-control" type="text" id="footer" name="footer">
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                      ...
                      <input class="form-control" type="text" name="publisher_key" id="publisher_key">
                  </div>
                  <div class="col-md-6">
                    <div class="mb-1">
                      ...
                      <select class="form-select select2" id="terminals" name="terminals[]" multiple>
                          ...
                          <?php echo get_airport_terminals();  ?>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-6">
                      <label class="form-label" for="introduction">Payment Redirection</label>
                      <select class="form-select select2" name="payment_redirection" id='payment_redirection' required>
                  ...
                  <div class="col-md-12">
                      ...
                      <textarea id="terms_condition" name="terms_condition"></textarea>
                  </div>
                  <div class="col-md-12">
                      <label class="form-label" for="privacy_policy">Privacy Policy</label>
                      <textarea id="privacy_policy" name="privacy_policy"></textarea>
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                      ...
                      <textarea id="contact_us" name="contact_us"></textarea>
                  </div>
              </div>
