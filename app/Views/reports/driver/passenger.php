                ...
                <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
                    ...
                    <div class="col-md-4 col-4">
                        <div class="mb-1">
                            ...
                            <select class="form-select select2" id="operator_id" name="operator_id">
                                <option value="*">All</option> 
                                <?php foreach ($operators as $key => $op) {
                                    echo'<option value="'.$op->id.'" '.$selected.'>'. $op->description .'</option>';
                                } ?>
                            </select>
                        </div>
                    </div>
                                ...
                                <table class="datatables-ajax table table-responsive" id="view-datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Empty Departure Passengers</th>
                                            <th>Return Passengers</th>
                                            <th>Empty Return Passengers</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
...
<script type="text/javascript">
    ...
    table = $('#view-datatable').DataTable({
        ...
        ajax: {
            url: "<?= url_to('reports/passenger/get'); ?> ",
            type: 'GET',
            data: function (d) {
                d.airport = $("#airport").val();
                d.operator_id = $("#operator_id").val();
