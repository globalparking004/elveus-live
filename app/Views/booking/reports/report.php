            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center mx-50 row pt-0 pb-2">
                    ...
                    <!-- <div class="col-md-3 col-3" style="<?= $display; ?>;">
                        <div class="mb-1">
                            <label class="form-label" for="band_name">Airport</label>
                    ...
                    <div class="col-md-6 col-6" style="<?= $display; ?>;">
                        <div class="mb-1">
                            <label class="form-label" for="contactNumber">Operator</label>
                                <select class="form-select select2" id="operator" name="operator[]" multiple required>
                        ...
                        <div class="col-md-6 col-6" style="<?= $display; ?>;">
                            <div class="mb-1">
                                <label class="form-label" for="airport">Product</label>
                    ...
                    <div class="col-md-6 col-6">
                        <div class="mb-1">
                            ...
                            <?php if (strval($role_id) > 1 && $role_id !=11) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" id="AGENT" class="form-control" name="AGENT" placeholder="" />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="mb-1">
...
<script type="text/javascript">
    ...
    table = $('#view-datatable').DataTable({
        ...
        select: true,
        ajax: {
            url: "<?= url_to('booking/capacity/report'); ?> ",
            type: 'GET',
            data: function (d) {
                ...
                d.DateTo = $("#DateTo").val();
                d.get_limiter_time = $("#get_limiter_time").val();
