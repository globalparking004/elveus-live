  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
        <button type="button" class="btn btn-primary waves-effect waves-float waves-light" href="javascript:void(0);"
          data-bs-toggle="modal" data-bs-target="#add-xlarge">
...
<div class="modal fade text-start" id="add-xlarge" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form class="form-crud" id="form-crud" action="<?= base_url('operators/save'); ?>">
        <?= csrf_field() ?>
        <input type="hidden" name="id" id="id" value="" />
        <div class="modal-header">
          <h4 class="modal-title" id="form-crud-title">Add Operators</h4>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-12">
              <div class="mb-1">
                ...
                <input type="text" id="capacity" class="form-control" placeholder="Capacity" name="capacity" />
              </div>
            </div>
            <div class="col-md-6 col-12">
              <div class="mb-1">
            ...
            <div class="col-md-6 col-12">
              <div class="mb-1">
                <label class="form-label" for="status">Status</label>
                <select class="form-select select2" id="get_limiter_time" name="get_limiter_time">
                  <?php
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#capacity').keypress(function(event) {
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res.status) {
          ...
          $("#get_limiter_time").val(res.data.get_limiter_time);
          $('#get_limiter_time').trigger('change');
