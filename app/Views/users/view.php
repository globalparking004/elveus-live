                ...
                <div class="row">
                  <div class="col-12">
                    <ul class="nav nav-tabs mt-1">
                      <li class="active"><a data-toggle="tab" href="#users" class="atab">Users</a></li>
                      <li><a data-toggle="tab" href="#devices" class="atab">Devices</a></li>
                    </ul>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-12">
                  <div class="mb-1">
                    ...
                    <select class="form-select select2" id="airport" name="airport[]" multiple>
                ...
                <div class="col-md-6 col-12">
                  <div class="mb-1">
                    <label class="form-label" for="airport">Operator</label>
                    <select class="form-select select2" id="operator" name="operator">
                        <option value="*">ALL</option>
                        <?php 
                          $airports=get_airports(); 
                          for ($i=0; $i<sizeof($get_operator); $i++) 
                          { 
                              echo "<option value='".$get_operator[$i]->id."'>".$get_operator[$i]->description."</option>";
                          }
                        ?>
                    </select>
                  </div>
        ...
        $.ajax({
            ...
            success: function (res) {
              ...
              {  
                 ...
                 $('#type').val('');
                 $("#airport").val('');
                 let airportString = res.data.airport;
                 let airportArray = airportString.split(',');             
                 $("#id").val(id);
                 ...
                 $("#airport").val(airportArray);
                 $("#operator").val(res.data.operator_id);
