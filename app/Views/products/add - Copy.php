            ...
            <div class="bs-stepper-content">
              <div id="contact-information-vertical" class="content" role="tabpanel" aria-labelledby="contact-information-vertical-trigger">
                ...
                <div class="row">
                  ...
                  <div class="mb-1 form-password-toggle col-md-4">
                    <label class="form-label" for="parent">Airport</label>
              ...
              <div id="availability-information-vertical" class="content" role="tabpanel" aria-labelledby="availability-information-vertical-trigger">
                ...
                <div class="row">
                  <div class="mb-1 col-md-4">
                    ...
                    <input type="text" id="linked_price" name="linked_price" class="form-control number-input" placeholder="Adjust Linked Prices" value="0.00" />
                  </div>
                </div>
              ...
              <div id="addons-information-vertical" class="content" role="tabpanel" aria-labelledby="addons-information-vertical-trigger">
                ...
                <!-- <div class="row" hidden>
                  <div class="mb-1 col-md-6">
                    ...
                    <input type="text" name="addon_name[]" class="form-control" placeholder="Addon Name" />
                  </div>
                  <div class="mb-1 col-md-6">
                    <label class="form-label">Addon Price</label>
                    <input type="text" name="addon_price[]" class="form-control number-input" placeholder="Addon Price" />
                  </div>
                </div>
  ...
  $('.moreAddonBtn').on('click', function()
    {
        ...
        let html ='<div class="mb-1 col-md-6  addon'+count+'">'+
                      ...
                      '<input type="text" name="addon_name[]" class="form-control" placeholder="Addon'+count+' Name" />'+
                    '</div><div class="mb-1 col-md-6  addon'+count+'">'+
                      '<label class="form-label">Addon'+count+' Price</label>'+
                      '<input type="text" name="addon_price[]" class="form-control" placeholder="Addon'+count+' Price" />'+
                    '</div>'+
                    '</div><div class="mb-1 col-md-10  addon'+count+'">'+
                      '<label class="form-label">Addon'+count+' Description</label>'+
                      '<textarea name="addon_desc[]" rows="3" class="form-control" placeholder="Addon Description..."></textarea>'+
                      '</div><div class="mt-3 col-md-2 addon'+count+'">'+
                      '<button type="button" class="btn btn-danger waves-effect waves-float waves-light removeAddon" data-id="'+count+'">Remove</button>'+
                    '</div>';
