            ...
            <div class="modal fade text-start" id="add-xlarge" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <div class="modal-content">
                    <form class="form-crud" id="form-crud" action="<?= base_url('promotion/save'); ?>">
                    <?= csrf_field() ?>
...
<script type="text/javascript">
    ...
    var validator=$(".form-crud").validate({
      ...
      {     
          $.ajax({
              url: "<?= base_url('promotion/get_record'); ?>",
              type: 'GET',
              dataType: 'json',
              ...
              success: function (res) {
                ...
                {  
                   ...
                   $("#form-crud").attr("action","<?= base_url('promotion/update'); ?>");
    ...
    //   }
      ...
      $("#add-xlarge").on("hidden.bs.modal", function () {
         ...
         $("#form-crud").attr("action","<?= base_url('promotion/save'); ?>");
         $(".clpassword").show();
      });
