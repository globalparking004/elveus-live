...
$csvDirectory = '/var/www/html/email_files/bristol/Parking4Younoreply@parking4you.co.uk/';
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
            $producr_code='';
            if($ProductID=="2284" || $ProductID=="91")
            {
                $producr_code='BRSMG';
            ...
            // }
                ...
                echo "no product match. ProductID:". $ProductID;
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BRS','P4U'
                )";
                print_r($sql);
