...
// $csvDirectory = '/var/www/html/email_files/bristol/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/bristol/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bristol/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/bristol/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bristol/AirportCheapParkingnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bristol/CompareParkingDealsnoreply@parking4you.co.uk/','/var/www/html/email_files/bristol/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
                $producr_code='';
                if($ProductID=="263" || $ProductID=="2284" || $ProductID=="91")
                {
                    $producr_code='BRSMG';
                }else{
                    // echo "no product match";
                    echo $ProductName." CPD no product match. ProductID:".$ProductID;
                    // exit;
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BRS','CPD'
                )";
                print_r($sql);
                ...
                echo "Error: productID: " .  $ProductID;
                exit;
            }
        }
        // Close the CSV file
