...
$array = ['/var/www/html/email_files/bristol/CompareYourParkingnoreply@compareyourparking.co.uk/','/var/www/html/email_files/bristol/CompareTheParkingnoreply@comparetheparking.co.uk/'];
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           // echo 'CYP-Order_date: '.$OrderDate;
            if($ProductName)
            {
                ...
                {
                    $producr_code='BRSMG';
                }elseif($ProductID == 373)
                {
                    $producr_code='BRSMGSP';
                }elseif($ProductID == 377)
                {
                    $producr_code='BRSPR';
                }else{
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BRS','CYP'
                )";
                print_r($sql);
