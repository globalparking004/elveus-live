...
$csvDirectory = '/var/www/html/email_files/bristol/YourTravelExtrasbooking@yourtravelextras.com/';
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if(!empty($Reference) and isset($Reference))
           {
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BRS','YTE'
            )";
