...
FOLDER_PATH = r'/var/www/html/email_files/dub@ukmails.co.uk/'

email_user = 'dub@ukmails.co.uk' #input('Email: ')
...
for num in data[0].split():    
    ...
    for part in email_message.walk():
        ...
        print(f' multipart: {part.get_content_maintype()}') 
        if part.get_content_maintype() == 'multipart':            
            continue
        
        print(f' CP: {part.get('Content-Disposition')}')
...
php_script = '/var/www/html/booking/emailparsing/dub@ukmails.co.uk/insert_email_files_data.php'
