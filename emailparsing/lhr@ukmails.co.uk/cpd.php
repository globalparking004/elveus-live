...
// $csvDirectory = '/var/www/html/email_files/lhr@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

// */5 * * * * /usr/bin/python3 /var/www/html/booking/emailparsing/lhr@ukmails.co.uk/email_parsing.py >> /var/www/html/booking/emailparsing/lhr@ukmails.co.uk/log.txt


$array=['/var/www/html/email_files/lhr@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/lhr@ukmails.co.uk/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/lhr@ukmails.co.uk/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/lhr@ukmails.co.uk/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/lhr@ukmails.co.uk/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
    ...
    if ($csvFile !== FALSE) {
       ...
       // Assuming $data is an array containing the CSV data
           ...
           if($ProductID)
           {
            ...
            if($ProductID=="243" || $ProductID=="204" || $ProductID=="171")
            {
                $producr_code='LHR';

            }
            // elseif($ProductID=="171")
            // {
            //     $producr_code='LHR';
            // }
            else{
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LHR','CPD'
            )";
            print_r($sql);
