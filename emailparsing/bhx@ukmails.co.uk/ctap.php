...
$array = ['/var/www/html/email_files/bhx/bookings@comparetheairportparking.com/','/var/www/html/email_files/bhx/CTAPBookingsbookings@comparetheairportparking.com/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
                $producr_code='';
                if($ProductName=="Economy Meet and Greet" 
                ...
                elseif($ProductName=="Express Meet & Greet")
                {
                    $producr_code='BHXMGValet';
                }elseif(isParkAndRide($ProductName) || $ProductName =='Birmingham Just Park & Fly'
                    || $ProductName=="Airport Parking Birmingham Self Park")
                {
                    $producr_code='BHXPR';
                }
                else{
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '', '$CustomerFullName', '$operator_id','Online','BHX','CTAP'
                )";
                print_r($sql);
