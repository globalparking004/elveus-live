...
// $csvDirectory = '/var/www/html/email_files/bhx/CompareParkingDealsnoreply@compareparkingdeals.co.uk/'; CompareTheParkingnoreply@comparetheparking.co.uk
$array=['/var/www/html/email_files/bhx/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bhx/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/bhx/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bhx/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bhx/AirportCheapParkingnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bhx/GoCompareParkingnoreply@airportparkingfinder.co.uk/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
            ...
            // echo 'CPD-ProductID: '.$ProductID;
           
           if($ProductID)
           {

            if($ProductID=="171" || $ProductID=="170")
            {
                $producr_code='BHXMGTRN';

            }
            elseif($ProductID=="151" || $ProductID=="152")
            {
                $producr_code='BHXMGValet';
            }
            elseif($ProductID=="193")
            {
                $producr_code='BHXPR';
            }
            else{
                echo $ProductID." no product match";
                // exit;
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BHX','CPD'
            )";
            // print_r($sql);die;
