...
$array=['/var/www/html/email_files/bhx/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/bhx/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/bhx/Parking4Younoreply@parking4you.co.uk/','/var/www/html/email_files/bhx/GoCompareParkingnoreply@parking4you.co.uk/'];
       ...
       // Assuming $data is an array containing the CSV data
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','BHX','P4U'
            )";
