...
$array = ['/var/www/html/email_files/bristol/bookings@comparetheairportparking.com/','/var/www/html/email_files/bristol/CTAPBookingsbookings@comparetheairportparking.com/'];
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if($ProductName)
           {
                ...
                if(isMeetAndGreet($ProductName) 
                    || $ProductName =='Platinum Parking Bristol'
                    || $ProductName)
                {
                    $producr_code='BRSMG';
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '', '$CustomerFullName', '$operator_id','Online','BRS','CTAP'
                )";
                print_r($sql);
