...
$csvDirectory = '/var/www/html/email_files/UmairRasheedumairrasheed57@gmail.com/';
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
       ...
       // Assuming $data is an array containing the CSV data
            ...
            $NoOfPassengers = $conn->real_escape_string($data[17]) ?? NULL;
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                carModel, carColour, contactNumber, passenger, firstName,operator_id,booking_type
            ) VALUES (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online'
            )";
