...
$array = ['/var/www/html/email_files/ltn/HolidayCarParkingno-reply@holidayscarparking.uk/', '/var/www/html/email_files/ltn/ParkingExpertsno-reply@holidayscarparking.uk/', '/var/www/html/email_files/ltn/ParkoTripLtdno-reply@parkotrip.co.uk/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
            ...
            $OrderPrice = $conn->real_escape_string($data[19]);
