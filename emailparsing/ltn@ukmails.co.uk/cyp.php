...
// Directory containing CSV files  CompareYourParkingnoreply@compareyourparking.uk
$array = ['/var/www/html/email_files/ltn/CompareYourParkingnoreply@compareyourparking.co.uk/','/var/www/html/email_files/ltn/CompareTheParkingnoreply@comparetheparking.co.uk/','/var/www/html/email_files/ltn/CompareYourParkingnoreply@compareyourparking.uk/'];
           ...
           // echo 'CYP-Order_date: '.$OrderDate;
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LTN','CYP'
                )";
                print_r($sql);
