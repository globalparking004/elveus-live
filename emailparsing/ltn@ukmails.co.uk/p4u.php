...
$array = ['/var/www/html/email_files/ltn/Parking4Younoreply@parking4you.co.uk/', '/var/www/html/email_files/ltn/GoCompareParkingnoreply@parking4you.co.uk/'];
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LTN','P4U'
            )";
