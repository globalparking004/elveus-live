...
$csvDirectory = '/var/www/html/email_files/ltn/YourTravelExtrasbooking@yourtravelextras.com/';
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if($ProductID)
           {
                ...
                if($ProductID=="110" || $ProductID ="274")
                {
                    $producr_code='LTNMG';

                }
                elseif($ProductID=="126")
                {
                    $producr_code='LTNPR';
                }
           ...
           if(!empty($Reference) and isset($Reference))
           {
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LTN','YTE'
            )";
