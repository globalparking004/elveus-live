...
// $csvDirectory = '/var/www/html/email_files/ltn/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/ltn/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/ltn/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/ltn/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/ltn/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if($ProductID)
           {
            ...
            if($ProductID=="110" || $ProductID ="274" || $ProductID ="2294")
            {
                $producr_code='LTNMG';
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LTN','CPD'
            )";
