...
FOLDER_PATH = r'/var/www/html/email_files/'

email_user = 'agents@birminghamairportparkingservices.co.uk' #input('Email: ')
...
php_script = '/var/www/html/booking/emailparsing/agents@birminghamairportparkingservices.co.uk/insert_email_files_data.php'
