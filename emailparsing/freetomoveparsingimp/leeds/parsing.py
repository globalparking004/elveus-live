...
FOLDER_PATH = r'/var/www/html/email_files/freeeetomove/leeds/'
IMAGES_PATH = os.path.join(FOLDER_PATH, 'images')
email_user = 'leeds@ukmails.co.uk'
...
for num in id_list:
    ...
    php_script = '/var/www/html/booking/emailparsing/freetomoveparsingimp/leeds/freetomoveinsertion.php'
