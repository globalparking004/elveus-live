...
FOLDER_PATH = r'/var/www/html/email_files/freeeetomove/lcy/'
IMAGES_PATH = os.path.join(FOLDER_PATH, 'images')
email_user = 'lcy@ukmails.co.uk'
email_pass = 'Hakuyasha@123'
...
for num in id_list:
    ...
    php_script = '/var/www/html/booking/emailparsing/freetomoveparsingimp/lcy/freetomoveinsertion.php'
