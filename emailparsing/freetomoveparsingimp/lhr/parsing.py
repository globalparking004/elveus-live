...
FOLDER_PATH = r'/var/www/html/email_files/freeeetomove/lhr/'
IMAGES_PATH = os.path.join(FOLDER_PATH, 'images')
email_user = 'lhr@goairportparking.com'
email_pass = 'Zarsin@123@'
...
def extract_details(email_body):
    ...
    cancelled_match = re.search(r'cancelled(?:\s\w+|:\s*\w+)', email_body, re.IGNORECASE)
    if cancelled_match:
...
for num in id_list:
    ...
    php_script = '/var/www/html/booking/emailparsing/freetomoveparsingimp/lhr/freetomoveinsertion.php'
