...
FOLDER_PATH = r'/var/www/html/email_files/freeeetomove/man/'
IMAGES_PATH = os.path.join(FOLDER_PATH, 'images')
email_user = 'man@ukmails.co.uk'
...
for num in id_list:
    ...
    php_script = '/var/www/html/booking/emailparsing/freetomoveparsingimp/man/freetomoveinsertion.php'
