<?php
//*1 * * * * /usr/bin/python3 /var/www/html/booking/emailparsing/man@ukmails.co.uk/email_parsing.py >> /var/www/html/booking/emailparsing/man@ukmails.co.uk/log.txt
...
// $csvDirectory = '/var/www/html/email_files/man@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/man@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/man@ukmails.co.uk/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/man@ukmails.co.uk/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/man@ukmails.co.uk/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
    ...
    if ($csvFile !== FALSE) {
       ...
       // Assuming $data is an array containing the CSV data
           ...
           if($ProductID)
           {
            ...
            if($ProductID=="60" || $ProductID=="92")
            {
                $producr_code='MANMG';
            }elseif($ProductID=="160")
            {
                $producr_code='MANPR';
            }
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','MAN','CPD'
            )";
            print_r($sql);
