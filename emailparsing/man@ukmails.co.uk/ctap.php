...
// Directory containing CSV files '/var/www/html/email_files/man@ukmails.co.uk/CTAPBookingsbookings@comparetheairportparking.com/'
$array = ['/var/www/html/email_files/man@ukmails.co.uk/bookings@comparetheairportparking.com/'];
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if($ProductName)
           {
                ...
                {
                    $producr_code='MANPR';
                }elseif ($ProductName == 'Express meet and greet' || $ProductName== 'Express Meet and Greet') {
                    $producr_code='MANMG';
                }
                else{
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '', '$CustomerFullName', '$operator_id','Online','MAN','CTAP'
                )";
                print_r($sql);
