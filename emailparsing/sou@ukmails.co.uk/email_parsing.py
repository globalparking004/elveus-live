...
FOLDER_PATH = r'/var/www/html/email_files/sou/'

email_user = 'sou@ukmails.co.uk' #input('Email: ')
...
php_script = '/var/www/html/booking/emailparsing/sou@ukmails.co.uk/p4u.php'
