...
// $csvDirectory = '/var/www/html/email_files/liverpool@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/liverpool@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/liverpool@ukmails.co.uk/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/liverpool@ukmails.co.uk/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/liverpool@ukmails.co.uk/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/liverpool@ukmails.co.uk/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
                $producr_code='';
            if($ProductID=="2289" || $ProductID="291")
            {
                $producr_code='LPLPR';
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LPL','CPD'
            )";
            print_r($sql);
