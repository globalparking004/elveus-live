...
$csvDirectory = '/var/www/html/email_files/liverpool@ukmails.co.uk/Parking4Younoreply@parking4you.co.uk/';
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LPL','P4U'
            )";
            print_r($data);
