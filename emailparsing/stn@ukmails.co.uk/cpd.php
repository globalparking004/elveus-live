...
$csvDirectory = '/var/www/html/email_files/stn@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/stn@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/CompareParkingDealsnoreply@parking4you.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
       ...
       // Assuming $data is an array containing the CSV data
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','STN','CPD'
            )";
