...
$database = 'bookings';
 ...
 // Run Manually: php /var/www/html/booking/emailparsing/stn@ukmails.co.uk/p4u.php

// Directory containing CSV files
$csvDirectories = ['/var/www/html/email_files/stn@ukmails.co.uk/Parking4Younoreply@parking4you.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/GoCompareParkingnoreply@parking4you.co.uk/'];
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if($ProductID)
           {
            ...
            if($ProductID=="180" || $ProductID=="124")
            {
                $producr_code='STNMG';
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','STN','P4U'
            )";
...
foreach($csvDirectories as $file)
{
