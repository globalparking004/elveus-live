...
$array = ['/var/www/html/email_files/stn@ukmails.co.uk/CompareYourParkingnoreply@compareyourparking.co.uk/','/var/www/html/email_files/stn@ukmails.co.uk/CompareTheParkingnoreply@comparetheparking.co.uk/'];
           ...
           // echo 'CYP-Order_date: '.$OrderDate;
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','STN','CYP'
                )";
                print_r($sql);
