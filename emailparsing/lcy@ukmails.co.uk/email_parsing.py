...
FOLDER_PATH = r'/var/www/html/email_files/lcy/'

email_user = 'lcy@ukmails.co.uk' #input('Email: ')
...
php_script = '/var/www/html/booking/emailparsing/lcy@ukmails.co.uk/p4u.php'
...
php_script2 = '/var/www/html/booking/emailparsing/lcy@ukmails.co.uk/yourtravelextras.php'
