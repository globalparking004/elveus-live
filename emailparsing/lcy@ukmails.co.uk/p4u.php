...
$array=['/var/www/html/email_files/lcy/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/lcy/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/lcy/Parking4Younoreply@parking4you.co.uk/','/var/www/html/email_files/lcy/GoCompareParkingnoreply@parking4you.co.uk/'];
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LCY','P4U'
            )";
            print_r($sql);
