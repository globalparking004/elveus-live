...
$array = ['/var/www/html/email_files/leeds@ukmails.co.uk/bookings@comparetheairportparking.com/','/var/www/html/email_files/leeds@ukmails.co.uk/CTAPBookingsbookings@comparetheairportparking.com/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
                $producr_code='';
                if($ProductName=="Budget Parking Meet & Greet Leeds" 
