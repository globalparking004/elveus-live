...
// $csvDirectory = '/var/www/html/email_files/leeds@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/leeds@ukmails.co.uk/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/leeds@ukmails.co.uk/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/leeds@ukmails.co.uk/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/leeds@ukmails.co.uk/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/leeds@ukmails.co.uk/AirportCheapParkingnoreply@compareparkingdeals.co.uk/'];
       ...
       // Assuming $data is an array containing the CSV data
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LBA','CPD'
            )";
            print_r($sql);
