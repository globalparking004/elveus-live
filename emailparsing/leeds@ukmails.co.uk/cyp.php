...
$array = ['/var/www/html/email_files/leeds@ukmails.co.uk/CompareYourParkingnoreply@compareyourparking.co.uk/','/var/www/html/email_files/leeds@ukmails.co.uk/CompareTheParkingnoreply@comparetheparking.co.uk/'];
           ...
           // echo 'CYP-Order_date: '.$OrderDate;
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LBA','CYP'
                )";
                print_r($sql);
