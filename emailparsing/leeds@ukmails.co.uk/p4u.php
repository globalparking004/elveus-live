...
$csvDirectory = '/var/www/html/email_files/leeds@ukmails.co.uk/Parking4Younoreply@parking4you.co.uk/';
...
// echo $Reference;
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','LBA','P4U'
            )";
