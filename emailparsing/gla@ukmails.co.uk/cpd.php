...
// $csvDirectory = '/var/www/html/email_files/gla/CompareParkingDealsnoreply@compareparkingdeals.co.uk/'; CompareTheParkingnoreply@comparetheparking.co.uk
$array=['/var/www/html/email_files/gla/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/gla/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/gla/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/gla/EasyHolidayParkAndFlynoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/gla/AirportCheapParkingnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/gla/GoCompareParkingnoreply@airportparkingfinder.co.uk/'];
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            $sql = "INSERT INTO tbl_booking (
                ...
                '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','GLA','CPD'
            )";
            // print_r($sql);die;
