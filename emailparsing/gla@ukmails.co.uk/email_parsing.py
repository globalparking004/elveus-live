...
FOLDER_PATH = r'/var/www/html/email_files/gla/'

email_user = 'gla@ukmails.co.uk' #input('Email: ')
...
php_script = '/var/www/html/booking/emailparsing/gla@ukmails.co.uk/cpd.php'
