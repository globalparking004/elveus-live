...
FOLDER_PATH = r'/var/www/html/email_files/dubmg@ukmails.co.uk/'

email_user = 'dubmg@ukmails.co.uk' #input('Email: ')
...
php_script = '/var/www/html/booking/emailparsing/csvdubmg@ukmails.co.uk/insert_email_files_data.php'
