...
$array = ['/var/www/html/email_files/sop/bookings@comparetheairportparking.com/','/var/www/html/email_files/sop/CTAPBookingsbookings@comparetheairportparking.com/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
                $producr_code='';
                if($ProductName=="Economy Meet and Greet" || $productName ="Express Park and Ride")
                {
            ...
            if ($producr_code) {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '', '$CustomerFullName', '$operator_id','Online','SOP','CTAP'
                )";
                print_r($sql);die;
