...
$csvDirectory = '/var/www/html/email_files/sop/Parking4Younoreply@parking4you.co.uk/';
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            if ($producr_code) 
            {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','SOP','P4U'
                )";
                print_r($sql);
