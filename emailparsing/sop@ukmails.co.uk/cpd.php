...
// $csvDirectory = '/var/www/html/email_files/sop/CompareParkingDealsnoreply@compareparkingdeals.co.uk/';

$array=['/var/www/html/email_files/sop/CompareParkingDealsnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/sop/Parking4Younoreply@compareairportparkings.co.uk/','/var/www/html/email_files/sop/Parking4Younoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/sop/AirportCheapParkingnoreply@compareparkingdeals.co.uk/','/var/www/html/email_files/sop/CompareParkingDealsnoreply@parking4you.co.uk/'];
...
function uploadAndInsertCSV($csvFilePath, $tableName, $conn) {
    ...
    if ($csvFile !== FALSE) {
        ...
        while (($data = fgetcsv($csvFile)) !== FALSE) {
           ...
           {
            $producr_code='';
            if($ProductID=="2295" || $ProductID =='276')
            {
           ...
           if(!empty($Reference) and isset($Reference)){
            ...
            if ($producr_code) 
            {
                ...
                $sql = "INSERT INTO tbl_booking (
                    ...
                    '$Model', '$Colour', '$ContactNumber', '$NoOfPassengers', '$CustomerFullName', '$operator_id','Online','SOP','CPD'
                )";
                print_r($sql);
